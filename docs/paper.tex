...
outputs (the \texttt{runs/} tree) are not in the GitHub repository
because of cumulative size and are available on request (see Appendix
A).
...
UK AI Safety Institute, Souly, A., Kirk, R., Merizian, J., D'Cruz, A.,
\& Davies, X. (2026). \emph{UK AISI Alignment Evaluation Case-Study.}
arXiv:2604.00788.

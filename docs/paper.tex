...
models' refusal behavior is consistent with additive attribution under
the pre-registered §5.5 decision tree.} This is a new finding V3 could
produce because of its 5-condition design; V1 and V2 only contrasted
``full inject vs no inject'' and could not see the per-clause
...
deployment'' claim, or (d) the combined frame. The pre-registered §4.3

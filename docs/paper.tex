...
Zhang, Ziegler, Hubinger, Batson, Lindsey, Zimmerman, \& Marks (2026).
\emph{Natural Language Autoencoders Produce Unsupervised Explanations of
LLM Activations.} Transformer Circuits Thread.

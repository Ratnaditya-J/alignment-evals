...
into multiple decodable / steerable states --- evaluation-awareness
among them --- and shows that steering these states modulates verbosity,
...
it as an isolated property. A related thread, important for interpreting
intrinsic-label results like our V2 finding, is the observation that
apparent eval-awareness evidence in benchmark contexts can collapse into
...
preprint title `Linear Control of Test Awareness Reveals Differential
...
Li, Bai, Liu, Zhang, \& Zeng (2026). \emph{Decomposing and Steering
Functional Metacognition in Large Language Models.} arXiv:2605.08942.
